...
public class MediaNotificationManager {
    ...
    public MediaNotificationManager(Context context) {
        ...
        playIntent.setAction(Constants.PLAY_OR_PAUSE_ACTION);
        ...
        prevIntent.setAction(Constants.PREVIOUS_ACTION);
    ...
    public void makeNotification(String title, String artist, Bitmap imageBitmap, boolean isPlaying, String imageUrl,
            boolean loadImage) {
        if (loadImage) {
